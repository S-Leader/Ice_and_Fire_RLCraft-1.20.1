...
public class IafItemRegistry {
    ...
    public static CustomArmorMaterial DRAGONSTEEL_ICE_ARMOR_MATERIAL = new DragonsteelArmorMaterial(
            ...
            new int[] { IafConfig.dragonsteelBaseArmor - 6, IafConfig.dragonsteelBaseArmor - 3,
                    IafConfig.dragonsteelBaseArmor, IafConfig.dragonsteelBaseArmor - 5 },
            30, SoundEvents.ARMOR_EQUIP_DIAMOND, IafConfig.dragonsteelBaseArmorToughness);
    public static CustomArmorMaterial DRAGONSTEEL_LIGHTNING_ARMOR_MATERIAL = new DragonsteelArmorMaterial(
            "dragonsteel_lightning", (int) (0.02D * IafConfig.dragonsteelBaseDurabilityEquipment),
            new int[] { IafConfig.dragonsteelBaseArmor - 6, IafConfig.dragonsteelBaseArmor - 3,
                    IafConfig.dragonsteelBaseArmor, IafConfig.dragonsteelBaseArmor - 5 },
            30, SoundEvents.ARMOR_EQUIP_DIAMOND, IafConfig.dragonsteelBaseArmorToughness);
    ...
    public static final RegistryObject<Item> SILVER_HELMET = registerItem("armor_silver_metal_helmet",
            () -> new ItemSilverArmor(SILVER_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> SILVER_CHESTPLATE = registerItem("armor_silver_metal_chestplate",
            () -> new ItemSilverArmor(SILVER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> SILVER_LEGGINGS = registerItem("armor_silver_metal_leggings",
            () -> new ItemSilverArmor(SILVER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistryObject<Item> SILVER_BOOTS = registerItem("armor_silver_metal_boots",
            () -> new ItemSilverArmor(SILVER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    public static final RegistryObject<Item> SILVER_SWORD = registerItem("silver_sword",
            () -> new ItemModSword(SILVER_TOOL_MATERIAL));
    public static final RegistryObject<Item> SILVER_SHOVEL = registerItem("silver_shovel",
            () -> new ItemModShovel(SILVER_TOOL_MATERIAL));
    public static final RegistryObject<Item> SILVER_PICKAXE = registerItem("silver_pickaxe",
            () -> new ItemModPickaxe(SILVER_TOOL_MATERIAL));
    public static final RegistryObject<Item> SILVER_AXE = registerItem("silver_axe",
            () -> new ItemModAxe(SILVER_TOOL_MATERIAL));
    public static final RegistryObject<Item> SILVER_HOE = registerItem("silver_hoe",
            () -> new ItemModHoe(SILVER_TOOL_MATERIAL));

    public static final RegistryObject<Item> COPPER_HELMET = registerItem("armor_copper_metal_helmet",
            () -> new ItemCopperArmor(COPPER_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> COPPER_CHESTPLATE = registerItem("armor_copper_metal_chestplate",
            () -> new ItemCopperArmor(COPPER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> COPPER_LEGGINGS = registerItem("armor_copper_metal_leggings",
            () -> new ItemCopperArmor(COPPER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistryObject<Item> COPPER_BOOTS = registerItem("armor_copper_metal_boots",
            () -> new ItemCopperArmor(COPPER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    public static final RegistryObject<Item> COPPER_SWORD = registerItem("copper_sword",
            () -> new ItemModSword(COPPER_TOOL_MATERIAL));
    public static final RegistryObject<Item> COPPER_SHOVEL = registerItem("copper_shovel",
            () -> new ItemModShovel(COPPER_TOOL_MATERIAL));
    public static final RegistryObject<Item> COPPER_PICKAXE = registerItem("copper_pickaxe",
            () -> new ItemModPickaxe(COPPER_TOOL_MATERIAL));
    public static final RegistryObject<Item> COPPER_AXE = registerItem("copper_axe",
            () -> new ItemModAxe(COPPER_TOOL_MATERIAL));
    public static final RegistryObject<Item> COPPER_HOE = registerItem("copper_hoe",
            () -> new ItemModHoe(COPPER_TOOL_MATERIAL));
    ...
    public static final RegistryObject<Item> DRAGONEGG_RED = registerItem("dragonegg_red",
            () -> new ItemDragonEgg(EnumDragonEgg.RED));
    public static final RegistryObject<Item> DRAGONEGG_GREEN = registerItem("dragonegg_green",
            () -> new ItemDragonEgg(EnumDragonEgg.GREEN));
    public static final RegistryObject<Item> DRAGONEGG_BRONZE = registerItem("dragonegg_bronze",
            () -> new ItemDragonEgg(EnumDragonEgg.BRONZE));
    public static final RegistryObject<Item> DRAGONEGG_GRAY = registerItem("dragonegg_gray",
            () -> new ItemDragonEgg(EnumDragonEgg.GRAY));
    public static final RegistryObject<Item> DRAGONEGG_BLUE = registerItem("dragonegg_blue",
            () -> new ItemDragonEgg(EnumDragonEgg.BLUE));
    public static final RegistryObject<Item> DRAGONEGG_WHITE = registerItem("dragonegg_white",
            () -> new ItemDragonEgg(EnumDragonEgg.WHITE));
    public static final RegistryObject<Item> DRAGONEGG_SAPPHIRE = registerItem("dragonegg_sapphire",
            () -> new ItemDragonEgg(EnumDragonEgg.SAPPHIRE));
    public static final RegistryObject<Item> DRAGONEGG_SILVER = registerItem("dragonegg_silver",
    ...
    public static final RegistryObject<Item> DRAGONSCALES_RED = registerItem("dragonscales_red",
            () -> new ItemDragonScales(EnumDragonEgg.RED));
    public static final RegistryObject<Item> DRAGONSCALES_GREEN = registerItem("dragonscales_green",
            () -> new ItemDragonScales(EnumDragonEgg.GREEN));
    public static final RegistryObject<Item> DRAGONSCALES_BRONZE = registerItem("dragonscales_bronze",
            () -> new ItemDragonScales(EnumDragonEgg.BRONZE));
    public static final RegistryObject<Item> DRAGONSCALES_GRAY = registerItem("dragonscales_gray",
            () -> new ItemDragonScales(EnumDragonEgg.GRAY));
    public static final RegistryObject<Item> DRAGONSCALES_BLUE = registerItem("dragonscales_blue",
            () -> new ItemDragonScales(EnumDragonEgg.BLUE));
    public static final RegistryObject<Item> DRAGONSCALES_WHITE = registerItem("dragonscales_white",
            () -> new ItemDragonScales(EnumDragonEgg.WHITE));
    public static final RegistryObject<Item> DRAGONSCALES_SAPPHIRE = registerItem("dragonscales_sapphire",
            () -> new ItemDragonScales(EnumDragonEgg.SAPPHIRE));
    public static final RegistryObject<Item> DRAGONSCALES_SILVER = registerItem("dragonscales_silver",
    ...
    public static final RegistryObject<Item> DRAGONBONE_SHOVEL = registerItem("dragonbone_shovel",
            () -> new ItemModShovel(DRAGONBONE_TOOL_MATERIAL));
    public static final RegistryObject<Item> DRAGONBONE_PICKAXE = registerItem("dragonbone_pickaxe",
            () -> new ItemModPickaxe(DRAGONBONE_TOOL_MATERIAL));
    public static final RegistryObject<Item> DRAGONBONE_AXE = registerItem("dragonbone_axe",
            () -> new ItemModAxe(DRAGONBONE_TOOL_MATERIAL));
    public static final RegistryObject<Item> DRAGONBONE_HOE = registerItem("dragonbone_hoe",
            () -> new ItemModHoe(DRAGONBONE_TOOL_MATERIAL));
    public static final RegistryObject<Item> DRAGONBONE_SWORD_FIRE = registerItem("dragonbone_sword_fire",
            () -> new ItemAlchemySword(FIRE_DRAGONBONE_TOOL_MATERIAL));
    public static final RegistryObject<Item> DRAGONBONE_SWORD_ICE = registerItem("dragonbone_sword_ice",
            () -> new ItemAlchemySword(ICE_DRAGONBONE_TOOL_MATERIAL));
    ...
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_IRON_1 = registerItem(
            "dragonarmor_iron_" + ItemDragonArmor.getNameForSlot(1),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.IRON, 1));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_IRON_2 = registerItem(
            "dragonarmor_iron_" + ItemDragonArmor.getNameForSlot(2),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.IRON, 2));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_IRON_3 = registerItem(
            "dragonarmor_iron_" + ItemDragonArmor.getNameForSlot(3),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.IRON, 3));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_COPPER_0 = registerItem(
            "dragonarmor_copper_" + ItemDragonArmor.getNameForSlot(0),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.COPPER, 0));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_COPPER_1 = registerItem(
            "dragonarmor_copper_" + ItemDragonArmor.getNameForSlot(1),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.COPPER, 1));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_COPPER_2 = registerItem(
            "dragonarmor_copper_" + ItemDragonArmor.getNameForSlot(2),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.COPPER, 2));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_COPPER_3 = registerItem(
            "dragonarmor_copper_" + ItemDragonArmor.getNameForSlot(3),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.COPPER, 3));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_GOLD_0 = registerItem(
            "dragonarmor_gold_" + ItemDragonArmor.getNameForSlot(0),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.GOLD, 0));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_GOLD_1 = registerItem(
            "dragonarmor_gold_" + ItemDragonArmor.getNameForSlot(1),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.GOLD, 1));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_GOLD_2 = registerItem(
            "dragonarmor_gold_" + ItemDragonArmor.getNameForSlot(2),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.GOLD, 2));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_GOLD_3 = registerItem(
            "dragonarmor_gold_" + ItemDragonArmor.getNameForSlot(3),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.GOLD, 3));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DIAMOND_0 = registerItem(
            "dragonarmor_diamond_" + ItemDragonArmor.getNameForSlot(0),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.DIAMOND, 0));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DIAMOND_1 = registerItem(
            "dragonarmor_diamond_" + ItemDragonArmor.getNameForSlot(1),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.DIAMOND, 1));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DIAMOND_2 = registerItem(
            "dragonarmor_diamond_" + ItemDragonArmor.getNameForSlot(2),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.DIAMOND, 2));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DIAMOND_3 = registerItem(
            "dragonarmor_diamond_" + ItemDragonArmor.getNameForSlot(3),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.DIAMOND, 3));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_SILVER_0 = registerItem(
            "dragonarmor_silver_" + ItemDragonArmor.getNameForSlot(0),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.SILVER, 0));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_SILVER_1 = registerItem(
            "dragonarmor_silver_" + ItemDragonArmor.getNameForSlot(1),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.SILVER, 1));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_SILVER_2 = registerItem(
            "dragonarmor_silver_" + ItemDragonArmor.getNameForSlot(2),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.SILVER, 2));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_SILVER_3 = registerItem(
            "dragonarmor_silver_" + ItemDragonArmor.getNameForSlot(3),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.SILVER, 3));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DRAGONSTEEL_FIRE_0 = registerItem(
            "dragonarmor_dragonsteel_fire_" + ItemDragonArmor.getNameForSlot(0),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.FIRE, 0));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DRAGONSTEEL_FIRE_1 = registerItem(
            "dragonarmor_dragonsteel_fire_" + ItemDragonArmor.getNameForSlot(1),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.FIRE, 1));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DRAGONSTEEL_FIRE_2 = registerItem(
            "dragonarmor_dragonsteel_fire_" + ItemDragonArmor.getNameForSlot(2),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.FIRE, 2));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DRAGONSTEEL_FIRE_3 = registerItem(
            "dragonarmor_dragonsteel_fire_" + ItemDragonArmor.getNameForSlot(3),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.FIRE, 3));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DRAGONSTEEL_ICE_0 = registerItem(
            "dragonarmor_dragonsteel_ice_" + ItemDragonArmor.getNameForSlot(0),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.ICE, 0));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DRAGONSTEEL_ICE_1 = registerItem(
            "dragonarmor_dragonsteel_ice_" + ItemDragonArmor.getNameForSlot(1),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.ICE, 1));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DRAGONSTEEL_ICE_2 = registerItem(
            "dragonarmor_dragonsteel_ice_" + ItemDragonArmor.getNameForSlot(2),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.ICE, 2));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DRAGONSTEEL_ICE_3 = registerItem(
            "dragonarmor_dragonsteel_ice_" + ItemDragonArmor.getNameForSlot(3),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.ICE, 3));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DRAGONSTEEL_LIGHTNING_0 = registerItem(
            "dragonarmor_dragonsteel_lightning_" + ItemDragonArmor.getNameForSlot(0),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.LIGHTNING, 0));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DRAGONSTEEL_LIGHTNING_1 = registerItem(
            "dragonarmor_dragonsteel_lightning_" + ItemDragonArmor.getNameForSlot(1),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.LIGHTNING, 1));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DRAGONSTEEL_LIGHTNING_2 = registerItem(
            "dragonarmor_dragonsteel_lightning_" + ItemDragonArmor.getNameForSlot(2),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.LIGHTNING, 2));
    public static final RegistryObject<ItemDragonArmor> DRAGONARMOR_DRAGONSTEEL_LIGHTNING_3 = registerItem(
            "dragonarmor_dragonsteel_lightning_" + ItemDragonArmor.getNameForSlot(3),
            () -> new ItemDragonArmor(ItemDragonArmor.DragonArmorType.LIGHTNING, 3));
    public static final RegistryObject<Item> DRAGON_MEAL = registerItem("dragon_meal", ItemGeneric::new);
    public static final RegistryObject<Item> SICKLY_DRAGON_MEAL = registerItem("sickly_dragon_meal",
            () -> new ItemGeneric(1));
    public static final RegistryObject<Item> CREATIVE_DRAGON_MEAL = registerItem("creative_dragon_meal",
            () -> new ItemGeneric(2));
    public static final RegistryObject<Item> FIRE_DRAGON_FLESH = registerItem(ItemDragonFlesh.getNameForType(0),
    ...
    public static final RegistryObject<Item> IRON_HIPPOGRYPH_ARMOR = registerItem("iron_hippogryph_armor",
            () -> new ItemGeneric(0, 1));
    public static final RegistryObject<Item> GOLD_HIPPOGRYPH_ARMOR = registerItem("gold_hippogryph_armor",
            () -> new ItemGeneric(0, 1));
    public static final RegistryObject<Item> DIAMOND_HIPPOGRYPH_ARMOR = registerItem("diamond_hippogryph_armor",
            () -> new ItemGeneric(0, 1));
    public static final RegistryObject<Item> HIPPOGRYPH_TALON = registerItem("hippogryph_talon",
            () -> new ItemGeneric(1));
    ...
    public static final RegistryObject<Item> SHEEP_HELMET = registerItem("sheep_helmet",
            () -> new ItemModArmor(SHEEP_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> SHEEP_CHESTPLATE = registerItem("sheep_chestplate",
            () -> new ItemModArmor(SHEEP_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> SHEEP_LEGGINGS = registerItem("sheep_leggings",
            () -> new ItemModArmor(SHEEP_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistryObject<Item> SHEEP_BOOTS = registerItem("sheep_boots",
            () -> new ItemModArmor(SHEEP_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    ...
    public static final RegistryObject<Item> HIPPOCAMPUS_FIN = registerItem("hippocampus_fin",
            () -> new ItemGeneric(1));
    public static final RegistryObject<Item> HIPPOCAMPUS_SLAPPER = registerItem("hippocampus_slapper",
            () -> new ItemHippocampusSlapper());
    public static final RegistryObject<Item> EARPLUGS = registerItem("earplugs",
            () -> new ItemModArmor(EARPLUGS_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> DEATH_WORM_CHITIN_YELLOW = registerItem("deathworm_chitin_yellow",
            ItemGeneric::new);
    public static final RegistryObject<Item> DEATH_WORM_CHITIN_WHITE = registerItem("deathworm_chitin_white",
            ItemGeneric::new);
    public static final RegistryObject<Item> DEATH_WORM_CHITIN_RED = registerItem("deathworm_chitin_red",
            ItemGeneric::new);
    ...
    public static final RegistryObject<Item> DEATHWORM_YELLOW_BOOTS = registerItem("deathworm_yellow_boots",
            () -> new ItemDeathwormArmor(DEATHWORM_0_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    public static final RegistryObject<Item> DEATHWORM_WHITE_HELMET = registerItem("deathworm_white_helmet",
            () -> new ItemDeathwormArmor(DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> DEATHWORM_WHITE_CHESTPLATE = registerItem("deathworm_white_chestplate",
            () -> new ItemDeathwormArmor(DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> DEATHWORM_WHITE_LEGGINGS = registerItem("deathworm_white_leggings",
            () -> new ItemDeathwormArmor(DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistryObject<Item> DEATHWORM_WHITE_BOOTS = registerItem("deathworm_white_boots",
            () -> new ItemDeathwormArmor(DEATHWORM_1_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    public static final RegistryObject<Item> DEATHWORM_RED_HELMET = registerItem("deathworm_red_helmet",
            () -> new ItemDeathwormArmor(DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> DEATHWORM_RED_CHESTPLATE = registerItem("deathworm_red_chestplate",
            () -> new ItemDeathwormArmor(DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> DEATHWORM_RED_LEGGINGS = registerItem("deathworm_red_leggings",
            () -> new ItemDeathwormArmor(DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistryObject<Item> DEATHWORM_RED_BOOTS = registerItem("deathworm_red_boots",
            () -> new ItemDeathwormArmor(DEATHWORM_2_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    public static final RegistryObject<Item> DEATHWORM_EGG = registerItem("deathworm_egg",
            () -> new ItemDeathwormEgg(false));
    public static final RegistryObject<Item> DEATHWORM_EGG_GIGANTIC = registerItem("deathworm_egg_giant",
            () -> new ItemDeathwormEgg(true));
    public static final RegistryObject<Item> DEATHWORM_TOUNGE = registerItem("deathworm_tounge",
            () -> new ItemGeneric(1));
    public static final RegistryObject<Item> DEATHWORM_GAUNTLET_YELLOW = registerItem("deathworm_gauntlet_yellow",
            () -> new ItemDeathwormGauntlet());
    public static final RegistryObject<Item> DEATHWORM_GAUNTLET_WHITE = registerItem("deathworm_gauntlet_white",
            () -> new ItemDeathwormGauntlet());
    ...
    public static final RegistryObject<Item> STYMPHALIAN_BIRD_FEATHER = registerItem("stymphalian_bird_feather",
            ItemGeneric::new);
    public static final RegistryObject<Item> STYMPHALIAN_ARROW = registerItem("stymphalian_arrow",
            () -> new ItemStymphalianArrow());
    public static final RegistryObject<Item> STYMPHALIAN_FEATHER_BUNDLE = registerItem("stymphalian_feather_bundle",
            () -> new ItemStymphalianFeatherBundle());
    public static final RegistryObject<Item> STYMPHALIAN_DAGGER = registerItem("stymphalian_bird_dagger",
            () -> new ItemStymphalianDagger());
    public static final RegistryObject<Item> TROLL_TUSK = registerItem("troll_tusk", ItemGeneric::new);
    public static final RegistryObject<Item> MYRMEX_DESERT_EGG = registerItem("myrmex_desert_egg",
            () -> new ItemMyrmexEgg(false));
    public static final RegistryObject<Item> MYRMEX_JUNGLE_EGG = registerItem("myrmex_jungle_egg",
            () -> new ItemMyrmexEgg(true));
    public static final RegistryObject<Item> MYRMEX_DESERT_RESIN = registerItem("myrmex_desert_resin",
            ItemGeneric::new);
    public static final RegistryObject<Item> MYRMEX_JUNGLE_RESIN = registerItem("myrmex_jungle_resin",
            ItemGeneric::new);
    public static final RegistryObject<Item> MYRMEX_DESERT_CHITIN = registerItem("myrmex_desert_chitin",
            ItemGeneric::new);
    public static final RegistryObject<Item> MYRMEX_JUNGLE_CHITIN = registerItem("myrmex_jungle_chitin",
            ItemGeneric::new);
    public static final RegistryObject<Item> MYRMEX_STINGER = registerItem("myrmex_stinger", ItemGeneric::new);
    public static final RegistryObject<Item> MYRMEX_DESERT_SWORD = registerItem("myrmex_desert_sword",
            () -> new ItemModSword(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistryObject<Item> MYRMEX_DESERT_SWORD_VENOM = registerItem("myrmex_desert_sword_venom",
            () -> new ItemModSword(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistryObject<Item> MYRMEX_DESERT_SHOVEL = registerItem("myrmex_desert_shovel",
            () -> new ItemModShovel(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistryObject<Item> MYRMEX_DESERT_PICKAXE = registerItem("myrmex_desert_pickaxe",
            () -> new ItemModPickaxe(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistryObject<Item> MYRMEX_DESERT_AXE = registerItem("myrmex_desert_axe",
            () -> new ItemModAxe(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistryObject<Item> MYRMEX_DESERT_HOE = registerItem("myrmex_desert_hoe",
            () -> new ItemModHoe(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistryObject<Item> MYRMEX_JUNGLE_SWORD = registerItem("myrmex_jungle_sword",
            () -> new ItemModSword(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistryObject<Item> MYRMEX_JUNGLE_SWORD_VENOM = registerItem("myrmex_jungle_sword_venom",
            () -> new ItemModSword(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistryObject<Item> MYRMEX_JUNGLE_SHOVEL = registerItem("myrmex_jungle_shovel",
            () -> new ItemModShovel(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistryObject<Item> MYRMEX_JUNGLE_PICKAXE = registerItem("myrmex_jungle_pickaxe",
            () -> new ItemModPickaxe(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistryObject<Item> MYRMEX_JUNGLE_AXE = registerItem("myrmex_jungle_axe",
            () -> new ItemModAxe(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistryObject<Item> MYRMEX_JUNGLE_HOE = registerItem("myrmex_jungle_hoe",
            () -> new ItemModHoe(MYRMEX_CHITIN_TOOL_MATERIAL));
    public static final RegistryObject<Item> MYRMEX_DESERT_STAFF = registerItem("myrmex_desert_staff",
            () -> new ItemMyrmexStaff(false));
    public static final RegistryObject<Item> MYRMEX_JUNGLE_STAFF = registerItem("myrmex_jungle_staff",
            () -> new ItemMyrmexStaff(true));
    public static final RegistryObject<Item> MYRMEX_DESERT_HELMET = registerItem("myrmex_desert_helmet",
            () -> new ItemModArmor(MYRMEX_DESERT_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> MYRMEX_DESERT_CHESTPLATE = registerItem("myrmex_desert_chestplate",
            () -> new ItemModArmor(MYRMEX_DESERT_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> MYRMEX_DESERT_LEGGINGS = registerItem("myrmex_desert_leggings",
            () -> new ItemModArmor(MYRMEX_DESERT_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistryObject<Item> MYRMEX_DESERT_BOOTS = registerItem("myrmex_desert_boots",
            () -> new ItemModArmor(MYRMEX_DESERT_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    public static final RegistryObject<Item> MYRMEX_JUNGLE_HELMET = registerItem("myrmex_jungle_helmet",
            () -> new ItemModArmor(MYRMEX_JUNGLE_ARMOR_MATERIAL, ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> MYRMEX_JUNGLE_CHESTPLATE = registerItem("myrmex_jungle_chestplate",
            () -> new ItemModArmor(MYRMEX_JUNGLE_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> MYRMEX_JUNGLE_LEGGINGS = registerItem("myrmex_jungle_leggings",
            () -> new ItemModArmor(MYRMEX_JUNGLE_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS));
    public static final RegistryObject<Item> MYRMEX_JUNGLE_BOOTS = registerItem("myrmex_jungle_boots",
            () -> new ItemModArmor(MYRMEX_JUNGLE_ARMOR_MATERIAL, ArmorItem.Type.BOOTS));
    public static final RegistryObject<Item> MYRMEX_DESERT_SWARM = registerItem("myrmex_desert_swarm",
    ...
    public static final RegistryObject<Item> AMPHITHERE_MACUAHUITL = registerItem("amphithere_macuahuitl",
            () -> new ItemAmphithereMacuahuitl());
    public static final RegistryObject<Item> SERPENT_FANG = registerItem("sea_serpent_fang", ItemGeneric::new);
    public static final RegistryObject<Item> SEA_SERPENT_ARROW = registerItem("sea_serpent_arrow",
    ...
    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_INGOT = registerItem("dragonsteel_fire_ingot",
            ItemGeneric::new);
    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_SWORD = registerItem("dragonsteel_fire_sword",
            () -> new ItemModSword(DRAGONSTEEL_TIER_FIRE));
    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_PICKAXE = registerItem("dragonsteel_fire_pickaxe",
            () -> new ItemModPickaxe(DRAGONSTEEL_TIER_FIRE));
    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_AXE = registerItem("dragonsteel_fire_axe",
            () -> new ItemModAxe(DRAGONSTEEL_TIER_FIRE));
    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_SHOVEL = registerItem("dragonsteel_fire_shovel",
            () -> new ItemModShovel(DRAGONSTEEL_TIER_FIRE));
    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_HOE = registerItem("dragonsteel_fire_hoe",
    ...
    public static final RegistryObject<Item> DRAGONSTEEL_FIRE_BOOTS = registerItem("dragonsteel_fire_boots",
            () -> new ItemDragonsteelArmor(DRAGONSTEEL_FIRE_ARMOR_MATERIAL, 3, ArmorItem.Type.BOOTS));
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_INGOT = registerItem("dragonsteel_ice_ingot",
            ItemGeneric::new);
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_SWORD = registerItem("dragonsteel_ice_sword",
            () -> new ItemModSword(DRAGONSTEEL_TIER_ICE));
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_PICKAXE = registerItem("dragonsteel_ice_pickaxe",
            () -> new ItemModPickaxe(DRAGONSTEEL_TIER_ICE));
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_AXE = registerItem("dragonsteel_ice_axe",
            () -> new ItemModAxe(DRAGONSTEEL_TIER_ICE));
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_SHOVEL = registerItem("dragonsteel_ice_shovel",
            () -> new ItemModShovel(DRAGONSTEEL_TIER_ICE));
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_HOE = registerItem("dragonsteel_ice_hoe",
            () -> new ItemModHoe(DRAGONSTEEL_TIER_ICE));
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_HELMET = registerItem("dragonsteel_ice_helmet",
            () -> new ItemDragonsteelArmor(DRAGONSTEEL_ICE_ARMOR_MATERIAL, 0, ArmorItem.Type.HELMET));
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_CHESTPLATE = registerItem("dragonsteel_ice_chestplate",
            () -> new ItemDragonsteelArmor(DRAGONSTEEL_ICE_ARMOR_MATERIAL, 1, ArmorItem.Type.CHESTPLATE));
    public static final RegistryObject<Item> DRAGONSTEEL_ICE_LEGGINGS = registerItem("dragonsteel_ice_leggings",
            () -> new ItemDragonsteelArmor(DRAGONSTEEL_ICE_ARMOR_MATERIAL, 2, ArmorItem.Type.LEGGINGS));
    ...
    public static final RegistryObject<Item> DRAGON_DEBUG_STICK = registerItem("dragon_debug_stick",
            () -> new ItemGeneric(1, true), false);
    public static final RegistryObject<Item> DREAD_SWORD = registerItem("dread_sword",
            () -> new ItemModSword(DREAD_SWORD_TOOL_MATERIAL));
    public static final RegistryObject<Item> DREAD_KNIGHT_SWORD = registerItem("dread_knight_sword",
            () -> new ItemModSword(DREAD_KNIGHT_TOOL_MATERIAL));
    public static final RegistryObject<Item> LICH_STAFF = registerItem("lich_staff", () -> new ItemLichStaff());
    public static final RegistryObject<Item> DREAD_QUEEN_SWORD = registerItem("dread_queen_sword",
            () -> new ItemModSword(DRAGONSTEEL_TIER_DREAD_QUEEN));
    public static final RegistryObject<Item> DREAD_QUEEN_STAFF = registerItem("dread_queen_staff",
            () -> new ItemDreadQueenStaff());
    ...
    public static final RegistryObject<BannerPatternItem> PATTERN_FIRE = registerItem("banner_pattern_fire",
    ...
    public static final RegistryObject<BannerPatternItem> PATTERN_EYE = registerItem("banner_pattern_eye",
            () -> new BannerPatternItem(BannerPatternTagGenerator.EYE_BANNER_PATTERN, unstackable()));
    public static final RegistryObject<BannerPatternItem> PATTERN_FAE = registerItem("banner_pattern_fae",
            () -> new BannerPatternItem(BannerPatternTagGenerator.FAE_BANNER_PATTERN, unstackable()));
    public static final RegistryObject<BannerPatternItem> PATTERN_FEATHER = registerItem("banner_pattern_feather",
            () -> new BannerPatternItem(BannerPatternTagGenerator.FEATHER_BANNER_PATTERN, unstackable()));
    public static final RegistryObject<BannerPatternItem> PATTERN_GORGON = registerItem("banner_pattern_gorgon",
    ...
    public static final RegistryObject<BannerPatternItem> PATTERN_WEEZER = registerItem("banner_pattern_weezer",
            () -> new BannerPatternItem(BannerPatternTagGenerator.WEEZER_BANNER_PATTERN, unstackable()));
    public static final RegistryObject<BannerPatternItem> PATTERN_DREAD = registerItem("banner_pattern_dread",
            () -> new BannerPatternItem(BannerPatternTagGenerator.DREAD_BANNER_PATTERN, unstackable()));
    ...
    static {
        ...
        for (BloodedDragonType type : BloodedDragonType.values()) {
            ...
            RegistryObject<Item> helmet = registerItem(prefix + "_helmet",
                    () -> new ItemBloodedArmor(type, ArmorItem.Type.HELMET));
            RegistryObject<Item> chestplate = registerItem(prefix + "_chestplate",
                    () -> new ItemBloodedArmor(type, ArmorItem.Type.CHESTPLATE));
            RegistryObject<Item> leggings = registerItem(prefix + "_leggings",
                    () -> new ItemBloodedArmor(type, ArmorItem.Type.LEGGINGS));
            RegistryObject<Item> boots = registerItem(prefix + "_boots",
    ...
    public static void setRepairMaterials(final RegisterEvent event) {
        ...
        for (BloodedDragonType.DragonElement element : BloodedDragonType.DragonElement.values()) {
            Item repairItem = ForgeRegistries.ITEMS.getValue(
                    new ResourceLocation("iceandfire", element.getRepairItemId()));
            if (repairItem != null) {
                BloodedArmorMaterial.fromElement(element).setRepairMaterial(Ingredient.of(repairItem));
            }
        }
    }
}
