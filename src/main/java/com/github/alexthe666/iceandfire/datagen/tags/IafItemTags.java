...
public class IafItemTags extends ItemTagsProvider {
    ...
    public static TagKey<Item> GEMS_RUBY = createForgeKey(GEMS + "/ruby");
    ...
    public static TagKey<Item> DRAGON_BONES = createForgeKey(BONES_PATH + "/dragon");
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(DRAGON_SKULLS).add(IafItemRegistry.DRAGON_SKULL_FIRE.get()).add(IafItemRegistry.DRAGON_SKULL_ICE.get()).add(IafItemRegistry.DRAGON_SKULL_LIGHTNING.get()).add(IafItemRegistry.DRAGON_SKULL_GOLD.get());
        ...
        tag(Tags.Items.ORES)
                ...
                .add(IafBlockRegistry.RUBY_ORE.get().asItem())
                .add(IafBlockRegistry.CHARED_RUBY_ORE.get().asItem())
                .add(IafBlockRegistry.FROZEN_SAPPHIRE_ORE.get().asItem())
                .add(IafBlockRegistry.CRACKLED_AMETHYST_ORE.get().asItem());
        ...
        tag(Tags.Items.RAW_MATERIALS).add(IafItemRegistry.RAW_SILVER.get());
        tag(createForgeKey("raw_materials/silver")).add(IafItemRegistry.RAW_SILVER.get());

        tag(Tags.Items.GEMS).add(IafItemRegistry.RUBY_GEM.get()).add(IafItemRegistry.SAPPHIRE_GEM.get());

        tag(GEMS_RUBY).add(IafItemRegistry.RUBY_GEM.get());

        tag(GEMS_SAPPHIRE).add(IafItemRegistry.SAPPHIRE_GEM.get());

        tag(Tags.Items.BONES).add(IafItemRegistry.DRAGON_BONE.get()).add(IafItemRegistry.WITHERBONE.get());
        tag(BONES_WITHER).add(IafItemRegistry.WITHERBONE.get());

        tag(Tags.Items.EGGS).add(IafItemRegistry.HIPPOGRYPH_EGG.get()).add(IafItemRegistry.DEATHWORM_EGG.get()).add(IafItemRegistry.DEATHWORM_EGG_GIGANTIC.get()).add(IafItemRegistry.MYRMEX_DESERT_EGG.get()).add(IafItemRegistry.MYRMEX_JUNGLE_EGG.get());

        // Not sure if this should be in the forge namespace or not (or if the recipes
        // should be using tags here)
        tag(STORAGE_BLOCKS_SCALES_DRAGON_FIRE).add(IafBlockRegistry.DRAGON_SCALE_RED.get().asItem()).add(IafBlockRegistry.DRAGON_SCALE_GREEN.get().asItem()).add(IafBlockRegistry.DRAGON_SCALE_BRONZE.get().asItem()).add(IafBlockRegistry.DRAGON_SCALE_GRAY.get().asItem());

        tag(STORAGE_BLOCKS_SCALES_DRAGON_ICE).add(IafBlockRegistry.DRAGON_SCALE_BLUE.get().asItem()).add(IafBlockRegistry.DRAGON_SCALE_WHITE.get().asItem()).add(IafBlockRegistry.DRAGON_SCALE_SAPPHIRE.get().asItem()).add(IafBlockRegistry.DRAGON_SCALE_SILVER.get().asItem());

        tag(STORAGE_BLOCKS_SCALES_DRAGON_LIGHTNING).add(IafBlockRegistry.DRAGON_SCALE_ELECTRIC.get().asItem()).add(IafBlockRegistry.DRAGON_SCALE_AMYTHEST.get().asItem()).add(IafBlockRegistry.DRAGON_SCALE_COPPER.get().asItem()).add(IafBlockRegistry.DRAGON_SCALE_BLACK.get().asItem());
        //
        ...
        tag(createForgeKey(STORAGE_BLOCK_PATH + "/sapphire")).add(IafBlockRegistry.RUBY_BLOCK.get().asItem());
        tag(createForgeKey(STORAGE_BLOCK_PATH + "/sapphire")).add(IafBlockRegistry.SAPPHIRE_BLOCK.get().asItem());

        tag(DRAGON_FOOD_MEAT)
                // Vanilla
                .add(Items.BEEF, Items.COOKED_BEEF).add(Items.CHICKEN, Items.COOKED_CHICKEN).add(Items.MUTTON, Items.COOKED_MUTTON).add(Items.PORKCHOP, Items.COOKED_PORKCHOP)
                // Farmer's Delight
                // .addOptionalTag(new ResourceLocation("forge", "raw_fishes"))
                .addOptionalTag(new ResourceLocation("forge", "raw_mutton")).addOptionalTag(new ResourceLocation("forge", "raw_pork")).addOptionalTag(new ResourceLocation("forge", "raw_chicken")).addOptionalTag(new ResourceLocation("forge", "raw_beef"))
                // .addOptionalTag(new ResourceLocation("forge", "cooked_fishes"))
                .addOptionalTag(new ResourceLocation("forge", "cooked_mutton")).addOptionalTag(new ResourceLocation("forge", "cooked_pork")).addOptionalTag(new ResourceLocation("forge", "cooked_chicken")).addOptionalTag(new ResourceLocation("forge", "cooked_beef"));

        tag(BREED_AMPITHERE).add(Items.COOKIE);

        tag(BREED_HIPPOCAMPUS).add(Items.PRISMARINE_CRYSTALS);

        tag(BREED_HIPPOGRYPH).add(Items.RABBIT_STEW);

        tag(TAME_HIPPOGRYPH).add(Items.RABBIT_FOOT);

        tag(HEAL_AMPITHERE).add(Items.COCOA_BEANS);

        tag(HEAL_COCKATRICE).addTag(Tags.Items.SEEDS).add(Items.ROTTEN_FLESH);

        tag(HEAL_HIPPOCAMPUS).add(Items.KELP);

        tag(HEAL_PIXIE).add(Items.SUGAR);

        tag(TAME_PIXIE).add(Items.CAKE);

        tag(TEMPT_DRAGON).add(IafItemRegistry.FIRE_STEW.get());

        tag(TEMPT_HIPPOCAMPUS).add(Items.KELP).add(Items.PRISMARINE_CRYSTALS);

        tag(TEMPT_HIPPOGRYPH).add(Items.RABBIT).add(Items.COOKED_RABBIT);

        tag(SCALES_DRAGON_FIRE).add(IafItemRegistry.DRAGONSCALES_RED.get()).add(IafItemRegistry.DRAGONSCALES_GREEN.get()).add(IafItemRegistry.DRAGONSCALES_BRONZE.get()).add(IafItemRegistry.DRAGONSCALES_GRAY.get());

        tag(SCALES_DRAGON_ICE).add(IafItemRegistry.DRAGONSCALES_BLUE.get()).add(IafItemRegistry.DRAGONSCALES_WHITE.get()).add(IafItemRegistry.DRAGONSCALES_SAPPHIRE.get()).add(IafItemRegistry.DRAGONSCALES_SILVER.get());

        tag(SCALES_DRAGON_LIGHTNING).add(IafItemRegistry.DRAGONSCALES_ELECTRIC.get()).add(IafItemRegistry.DRAGONSCALES_AMYTHEST.get()).add(IafItemRegistry.DRAGONSCALES_COPPER.get()).add(IafItemRegistry.DRAGONSCALES_BLACK.get());

        tag(createKey("scales/dragon")).addTag(SCALES_DRAGON_FIRE).addTag(SCALES_DRAGON_ICE).addTag(SCALES_DRAGON_LIGHTNING);
