...
public class IafItemTags extends ItemTagsProvider {
        ...
        // Forge (+ Recipes)
        public static TagKey<Item> STORAGE_BLOCKS_SCALES_DRAGON_FIRE = createForgeKey(
                        STORAGE_BLOCK_PATH + "/scales/dragon/fire");
        public static TagKey<Item> STORAGE_BLOCKS_SCALES_DRAGON_ICE = createForgeKey(
                        STORAGE_BLOCK_PATH + "/scales/dragon/ice");
        public static TagKey<Item> STORAGE_BLOCKS_SCALES_DRAGON_LIGHTNING = createForgeKey(
                        STORAGE_BLOCK_PATH + "/scales/dragon/lightning");
        ...
        public IafItemTags(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider,
        ...
        protected void addTags(HolderLookup.Provider provider) {
                ...
                tag(DRAGON_SKULLS)
                                ...
                                .add(IafItemRegistry.DRAGON_SKULL_GOLD.get());
                ...
                tag(DRAGON_BLOODS)
                                ...
                                .add(IafItemRegistry.GOLD_DRAGON_BLOOD.get());
                ...
                tag(Tags.Items.INGOTS)
                                ...
                                .add(IafItemRegistry.DRAGONSTEEL_GOLD_INGOT.get());
                ...
                tag(createForgeKey(STORAGE_BLOCK_PATH + "/raw_silver"))
                                .add(IafBlockRegistry.RAW_SILVER_BLOCK.get().asItem());
                tag(createForgeKey(STORAGE_BLOCK_PATH + "/sapphire"))
                                .add(IafBlockRegistry.SAPPHIRE_BLOCK.get().asItem());
                ...
                tag(DRAGON_HEARTS)
                                ...
                                .add(IafItemRegistry.GOLD_DRAGON_HEART.get());
