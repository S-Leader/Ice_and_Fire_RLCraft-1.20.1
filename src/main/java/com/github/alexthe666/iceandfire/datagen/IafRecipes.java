...
public class IafRecipes extends RecipeProvider {
    ...
    private void createShaped(@NotNull final Consumer<FinishedRecipe> consumer) {
        ...
        nineBlockStorageRecipes(consumer, RecipeCategory.MISC, IafItemRegistry.DRAGON_BONE.get(),
                RecipeCategory.BUILDING_BLOCKS, IafBlockRegistry.DRAGON_BONE_BLOCK.get(),
                locationString("dragon_bone_block"), null, locationString("dragonbone"), null);
        ...
        compact(consumer, IafItemRegistry.DRAGONSCALES_BRONZE.get(),
                IafBlockRegistry.DRAGON_SCALE_BRONZE.get());
        ...
        compact(consumer, IafItemRegistry.DRAGONSCALES_SAPPHIRE.get(),
                IafBlockRegistry.DRAGON_SCALE_SAPPHIRE.get());
        compact(consumer, IafItemRegistry.DRAGONSCALES_SILVER.get(),
                IafBlockRegistry.DRAGON_SCALE_SILVER.get());

        compact(consumer, IafItemRegistry.DRAGONSCALES_ELECTRIC.get(),
                IafBlockRegistry.DRAGON_SCALE_ELECTRIC.get());
        compact(consumer, IafItemRegistry.DRAGONSCALES_AMYTHEST.get(),
                IafBlockRegistry.DRAGON_SCALE_AMYTHEST.get());
        compact(consumer, IafItemRegistry.DRAGONSCALES_COPPER.get(),
                IafBlockRegistry.DRAGON_SCALE_COPPER.get());
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS,
                        IafBlockRegistry.DREAD_STONE_BRICKS_CHISELED.get())
                .pattern("D")
                .pattern("D")
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS, IafBlockRegistry.DREAD_STONE_BRICKS_SLAB.get(),
                        6)
                .pattern("DDD")
                .define('D', IafBlockRegistry.DREAD_STONE_BRICKS.get())
                .unlockedBy("has_item", has(IafBlockRegistry.DREAD_STONE_BRICKS.get()))
        ...
        ShapedRecipeBuilder
                .shaped(RecipeCategory.BUILDING_BLOCKS,
                        IafBlockRegistry.DREAD_STONE_BRICKS_STAIRS.get(), 4)
                .pattern("D  ")
                .pattern("DD ")
                .pattern("DDD")
                .define('D', IafBlockRegistry.DREAD_STONE_BRICKS.get())
        ...
        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(IafBlockRegistry.RUBY_ORE.get()), RecipeCategory.TOOLS,
                        IafItemRegistry.RUBY_GEM.get(), 0.7f, 200)
                .group("ruby_gem")
                .unlockedBy(getHasName(IafBlockRegistry.RUBY_ORE.get()),
                        has(IafBlockRegistry.RUBY_ORE.get()))
                .save(consumer, location(getItemName(IafItemRegistry.RUBY_GEM.get()))
                        + "_from_smelting_" + getItemName(IafBlockRegistry.RUBY_ORE.get()));
        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(IafBlockRegistry.CHARED_RUBY_ORE.get()), RecipeCategory.TOOLS,
                        IafItemRegistry.RUBY_GEM.get(), 0.7f, 200)
                .group("ruby_gem")
                .unlockedBy(getHasName(IafBlockRegistry.CHARED_RUBY_ORE.get()),
                        has(IafBlockRegistry.CHARED_RUBY_ORE.get()))
                .save(consumer, location(getItemName(IafItemRegistry.RUBY_GEM.get()))
                        + "_from_smelting_" + getItemName(IafBlockRegistry.CHARED_RUBY_ORE.get()));

        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(IafBlockRegistry.FROZEN_SAPPHIRE_ORE.get()), RecipeCategory.TOOLS,
                        IafItemRegistry.SAPPHIRE_GEM.get(), 0.7f, 200)
                .group("sapphire_gem")
                .unlockedBy(getHasName(IafBlockRegistry.FROZEN_SAPPHIRE_ORE.get()),
                        has(IafBlockRegistry.FROZEN_SAPPHIRE_ORE.get()))
                .save(consumer, location(getItemName(IafItemRegistry.SAPPHIRE_GEM.get()))
                        + "_from_smelting_" + getItemName(IafBlockRegistry.FROZEN_SAPPHIRE_ORE.get()));
        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(IafBlockRegistry.CRACKLED_AMETHYST_ORE.get()), RecipeCategory.TOOLS,
                        Items.AMETHYST_SHARD, 0.7f, 200)
                .group("amethyst_shard")
                .unlockedBy(getHasName(IafBlockRegistry.CRACKLED_AMETHYST_ORE.get()),
                        has(IafBlockRegistry.CRACKLED_AMETHYST_ORE.get()))
                .save(consumer, location(getItemName(Items.AMETHYST_SHARD))
                        + "_from_smelting_" + getItemName(IafBlockRegistry.CRACKLED_AMETHYST_ORE.get()));

        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(IafItemRegistry.RAW_SILVER.get()), RecipeCategory.TOOLS,
                        IafItemRegistry.SILVER_INGOT.get(), 0.7f, 200)
                .group("raw_silver")
                .unlockedBy(getHasName(IafItemRegistry.RAW_SILVER.get()),
                        has(IafItemRegistry.RAW_SILVER.get()))
                .save(consumer, location(getItemName(IafItemRegistry.SILVER_INGOT.get()))
                        + "_from_smelting_" + getItemName(IafItemRegistry.RAW_SILVER.get()));
        SimpleCookingRecipeBuilder
                .blasting(Ingredient.of(IafItemRegistry.RAW_SILVER.get()), RecipeCategory.TOOLS,
                        IafItemRegistry.SILVER_INGOT.get(), 0.7f, 100)
                .group("raw_silver")
                .unlockedBy(getHasName(IafItemRegistry.RAW_SILVER.get()),
                        has(IafItemRegistry.RAW_SILVER.get()))
                .save(consumer, location(getItemName(IafItemRegistry.SILVER_INGOT.get()))
                        + "_from_blasting_" + getItemName(IafItemRegistry.RAW_SILVER.get()));
    ...
    private void createShapeless(@NotNull final Consumer<FinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.BUILDING_BLOCKS,
                        IafBlockRegistry.DREAD_STONE_BRICKS_MOSSY.get())
                .requires(Items.VINE)
        ...
        ShapelessRecipeBuilder
                .shapeless(RecipeCategory.BUILDING_BLOCKS, IafBlockRegistry.DREADWOOD_PLANKS.get(), 4)
    ...
    private void compact(@NotNull final Consumer<FinishedRecipe> consumer, final ItemLike unpacked,
                         final ItemLike packed) {
    ...
    private void toolSet(@NotNull final Consumer<FinishedRecipe> consumer, final TagKey<Item> material,
                         final TagKey<Item> handle, final ItemLike... items) {
        toolSet(consumer, Ingredient.of(material), Ingredient.of(handle), items);
    }

    private void toolSet(@NotNull final Consumer<FinishedRecipe> consumer, final ItemLike material,
                         final TagKey<Item> handle, final ItemLike... items) {
        toolSet(consumer, Ingredient.of(material), Ingredient.of(handle), items);
    }

    private void toolSet(@NotNull final Consumer<FinishedRecipe> consumer, final TagKey<Item> material,
                         final ItemLike handle, final ItemLike... items) {
        toolSet(consumer, Ingredient.of(material), Ingredient.of(handle), items);
    }
    ...
    private void toolSet(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient material,
    ...
    private void armorSet(@NotNull final Consumer<FinishedRecipe> consumer, final TagKey<Item> tag,
                          final ItemLike... results) {
        armorSet(consumer, Ingredient.of(tag), results);
    }

    private void armorSet(@NotNull final Consumer<FinishedRecipe> consumer, final ItemLike item,
                          final ItemLike... results) {
        armorSet(consumer, Ingredient.of(item), results);
    }

    private void armorSet(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient ingredient,
                          final ItemLike... results) {
        for (ItemLike result : results) {
            if (result.asItem() instanceof ArmorItem armorItem) {
                switch (armorItem.getType()) {
                    ...
                    default -> throw new IllegalArgumentException(
                            "Result is not a valid armor item: [" + result + "]");
                }
            } else {
    ...
    private void helmet(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient ingredient,
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, result)
                ...
                .define('#', ingredient)
                .unlockedBy("has_item",
                        has(Arrays.stream(ingredient.getItems()).findFirst().get().getItem()))
                .save(consumer);
    }

    private void chestPlate(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient ingredient,
                            final ItemLike result) {
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, result)
                .pattern("# #")
                .pattern("###")
    ...
    private void leggings(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient ingredient,
                          final ItemLike result) {
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, result)
                .pattern("###")
                .pattern("# #")
    ...
    private void boots(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient ingredient,
                       final ItemLike result) {
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, result)
                .pattern("# #")
                .pattern("# #")
    ...
    private void sword(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient material,
                       final Ingredient handle, final ItemLike result) {
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, result)
                ...
                .define('H', handle)
                .unlockedBy("has_item",
                        has(Arrays.stream(material.getItems()).findFirst().get().getItem()))
                .save(consumer);
    }

    private void pickaxe(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient material,
                         final Ingredient handle, final ItemLike result) {
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, result)
                .pattern("MMM")
                .pattern(" H ")
    ...
    private void axe(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient material,
                     final Ingredient handle, final ItemLike result) {
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, result)
                .pattern("MM")
                .pattern("MH")
    ...
    private void shovel(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient material,
                        final Ingredient handle, final ItemLike result) {
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, result)
                .pattern("M")
                .pattern("H")
    ...
    private void hoe(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient material,
                     final Ingredient handle, final ItemLike result) {
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, result)
                .pattern("MM")
                .pattern(" H")
    ...
    private void dragonArmorSet(@NotNull final Consumer<FinishedRecipe> consumer, final ItemLike material,
                                final ItemLike... results) {
        dragonArmorSet(consumer, Ingredient.of(material), results);
    }

    private void dragonArmorSet(@NotNull final Consumer<FinishedRecipe> consumer, final TagKey<Item> tag,
                                final ItemLike... results) {
        dragonArmorSet(consumer, Ingredient.of(tag), results);
    }

    private void dragonArmorSet(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient ingredient,
                                final ItemLike... results) {
        for (ItemLike result : results) {
            if (result instanceof ItemDragonArmor dragonArmor) {
                switch (dragonArmor.dragonSlot) {
                    ...
                    default -> throw new IllegalArgumentException(
                            "Result is not a valid dragon armor [" + result + "]");
                }
            } else {
    ...
    private void dragonHead(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient ingredient,
                            final ItemLike result) {
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, result)
                .pattern("   ")
                .pattern(" ##")
    ...
    private void dragonNeck(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient ingredient,
                            final ItemLike result) {
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, result)
                .pattern("   ")
                .pattern("###")
    ...
    private void dragonBody(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient ingredient,
                            final ItemLike result) {
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, result)
                .pattern("###")
                .pattern("###")
    ...
    private void dragonTail(@NotNull final Consumer<FinishedRecipe> consumer, final Ingredient ingredient,
                            final ItemLike result) {
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, result)
                .pattern("   ")
                .pattern("  #")
    ...
    private void forgeBrick(@NotNull final Consumer<FinishedRecipe> consumer, final ItemLike brick,
                            final TagKey<Item> scales, final ItemLike result) {
    ...
    private void forgeInput(@NotNull final Consumer<FinishedRecipe> consumer, final ItemLike brick,
                            final TagKey<Item> material, final ItemLike result) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, result)
                .pattern("BIB")
                .pattern("I I")
                .pattern("BIB")
    ...
    private void podium(@NotNull final Consumer<FinishedRecipe> consumer, final ItemLike planks,
                        final ItemLike slab, final ItemLike result) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, result)
                .pattern("SPS")
                .pattern(" P ")
                .pattern("SPS")
